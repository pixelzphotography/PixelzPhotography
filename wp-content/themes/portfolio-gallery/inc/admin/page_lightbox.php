  ...
  function __construct(){
    ...
    $this->options = array( 
      ...
      'lbox_slideshow_interval' => array( 
        ...
        "title" => __("Slideshow interval.", "portfolio-gallery"), 
        'type' => 'number',
        'input_size' => '3',
        "sanitize_type" => "sanitize_text_field", 
        "description" => __("Interval of slideshow in seconds.", "portfolio-gallery"),
        'min' => 1,
        'step' => 0.1,
        'section' => 'lightbox', 
        'tab' => 'lightbox',
      ...
      'lbox_image_width' => array( 
        ...
        "title" => __("Lightbox width.", "portfolio-gallery"), 
        'type' => 'number',
        'input_size' => '4', 
        "sanitize_type" => "sanitize_text_field", 
        "description" => __("Lightbox width.", "portfolio-gallery"), 
        'min' => 100,
        'step' => 10,
        'max' => 1200,
        'section' => 'lightbox', 
      ...
      'lbox_image_height' => array( 
        ...
        "title" => __("Lightbox height.", "portfolio-gallery"), 
        'type' => 'number',
        'input_size' => '4',
        'min' => 100,
        'step' => 10,
        'max' => 1200,
        "sanitize_type" => "sanitize_text_field", 
        "description" => __("Lightbox height.", "portfolio-gallery"), 
        'section' => 'lightbox', 
        'tab' => 'lightbox',
        'default' => 400 ,
        'customizer' => array()
      ...
      $this->options["lbox_image_effect"] = array(
        ...
        "title" => __("Lightbox transition effect", "portfolio-gallery"), 
        'type' => 'select',
        "valid_options" => array(
                            'none'=>'None',
        ...
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Lightbox transition effect", "portfolio-gallery" ),
        'section' => 'lightbox', 
        'tab' => 'lightbox', 
        'default' => array('fade'),
        'customizer' => array()
      ...
      $this->options['lbox_enable_image_fullscreen'] = array(
        ...
        'title' =>  __( 'Enable fullscreen buttons', "portfolio-gallery" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_open_with_fullscreen'] = array(
        ...
        'title' =>  __( 'Open lightbox with fullscreen.', "portfolio-gallery" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_enable_image_ctrl_btn'] = array(
        ...
        'title' =>  __( 'Enable play and pause buttons.', "portfolio-gallery" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_open_with_autoplay'] = array(
        ...
        'title' =>  __( 'Open with autoplay.', "portfolio-gallery" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_popup_enable_info'] = array(
        ...
        'title' =>  __( 'Enable info in lightbox.', "portfolio-gallery" ), 
        'type' => 'checkbox_open', 
        'description' => __( 'Add post title and excerpt as image info in lightbox.', "portfolio-gallery" ), 
        'section' => 'lightbox',
    ...
    $this->options['lbox_popup_info_always_show'] = array(
        ...
        'title' =>  __( 'Always show info in lightbox.', "portfolio-gallery" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
    ...
    $this->options['lbox_popup_info_full_width'] = array(
        ...
        'title' =>  __( 'Full-width info in lightbox.', "portfolio-gallery" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options["lbox_info_position"] = array(
        ...
        "title" => __("Image info position", "portfolio-gallery" ),
        'type' => 'select',
        "description" => "",
        "valid_options" => array(
          "left-top" => "left-top",
